...
$user = $user ?? ['photo_profil' => '/assets/images/default-avatar.png', 'login_utilisateur' => 'Utilisateur'];
            ...
            <div class="flex-none">
                    ...
                    <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow-xl bg-base-100 rounded-box w-56 border border-base-200 animate-fade-in-down">
                        ...
                        <li>
                            <form action="/logout" method="post" class="w-full">
                                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($_SESSION['csrf_token_logout'] ?? '') ?>">
                ...
                <button class="btn btn-ghost btn-circle ml-2 tooltip tooltip-bottom" id="toggle-notifications" data-tip="Notifications">
                    <div class="indicator">
                        ...
                        <span class="badge badge-sm badge-error indicator-item font-bold text-xs">99+</span>
                    </div>
                </button>
            </div>
        </header>
